<section id="noticias" class="container-fluid">
    ...
    <div class="row"><!-- Linha 1-->
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            ...
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia1">leia mais...</button>
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            ...
            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia2">leia mais...</button>
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            ...
            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia3">leia mais...</button>
    ...
    <div class="row"><!-- Linha 2-->
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            ...
            <div class="panel-body">Resumo da notícia 4...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia4">leia mais...</button>

            <!-- Modal -->
            <div id="noticia4" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 4</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">01/12/2015 20:44:15</time>
                            <p>Autor: Fulano de Tal</p>

                            <p>Parágrafo 1 da notícia 4</p>
                            <p>Parágrafo 2 da notícia 4</p>
                            <p>Parágrafo 3 da notícia 4</p>
            ...
            <!-- Fim da Modal -->
        </div><!-- Painel notícia 4-->
        
        <!-- Painel de Notícia 5-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 5</div>
            <div class="panel-body">Resumo da notícia 5...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia5">leia mais...</button>

            <!-- Modal -->
            <div id="noticia5" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 5</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">30/11/2015 19:30:45</time>
                            <p>Autor: Sicrano Mingal</p>

                            <p>Parágrafo 1 da notícia 5</p>
                            <p>Parágrafo 2 da notícia 5</p>
                            <p>Parágrafo 3 da notícia 5</p>
            ...
            <!-- Fim da Modal -->
        </div><!-- Painel notícia 5-->

        <!-- Painel de Notícia 6-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 6</div>
            <div class="panel-body">Resumo da notícia 6...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia6">leia mais...</button>

            <!-- Modal -->
            <div id="noticia6" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 6</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">25/10/2015 10:20:05</time>
                            <p>Autor: Teobaldo Mingal</p>

                            <p>Parágrafo 1 da notícia 6</p>
                            <p>Parágrafo 2 da notícia 6</p>
                            <p>Parágrafo 3 da notícia 6</p>
    ...
    <div class="row"><!-- Linha 3-->
        ...
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            ...
            <div class="panel-body">Resumo da notícia 7...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia7">leia mais...</button>

            <!-- Modal -->
            <div id="noticia7" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 7</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">01/10/2015 20:44:15</time>
                            <p>Autor: Fulano de Tal</p>

                            <p>Parágrafo 1 da notícia 7</p>
                            <p>Parágrafo 2 da notícia 7</p>
                            <p>Parágrafo 3 da notícia 7</p>
            ...
            <!-- Fim da Modal -->
        </div><!-- Painel notícia 7-->
        
        <!-- Painel de Notícia 8-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 8</div>
            <div class="panel-body">Resumo da notícia 8...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia8">leia mais...</button>

            <!-- Modal -->
            <div id="noticia8" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 8</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">23/10/2015 17:30:45</time>
                            <p>Autor: Sicrano Mingal</p>

                            <p>Parágrafo 1 da notícia 8</p>
                            <p>Parágrafo 2 da notícia 8</p>
                            <p>Parágrafo 3 da notícia 8</p>
            ...
            <!-- Fim da Modal -->
        </div><!-- Painel notícia 8-->

        <!-- Painel de Notícia 9-->
        <div class="panel panel-success col-lg-3 col-md-3 col-sm-3">
            <div class="panel-heading">Título da Notícia 9</div>
            <div class="panel-body">Resumo da notícia 9...</div>

            <!-- botão que dispara a modal -->
            <button type="button" class="btn btn-success center" data-toggle="modal" data-target="#noticia9">leia mais...</button>

            <!-- Modal -->
            <div id="noticia9" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Título da Notícia 9</h4>
                        </div>
                        <div class="modal-body">
                            <time class="h4">12/10/2015 11:20:05</time>
                            <p>Autor: Teobaldo Mingal</p>

                            <p>Parágrafo 1 da notícia 9</p>
                            <p>Parágrafo 2 da notícia 9</p>
                            <p>Parágrafo 3 da notícia 9</p>
